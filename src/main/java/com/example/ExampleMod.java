...
import com.example.items.MugCan;
import com.example.items.MugEssence;
...
public class ExampleMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registries.ITEM, new Identifier("mugmod", "mug_can"), MUG_ROOT_BEER);
		Registry.register(Registries.ITEM, new Identifier("mugmod", "mug_essence"), MUG_ESSENCE);
		Registry.register(Registries.ITEM_GROUP, new Identifier("mugmod", "mug"), MUG_ITEM_GROUP);
	}
}